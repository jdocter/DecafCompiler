...
_block_106:
	...
	addq -56(%rbp), %rax
	movq %rax, -88(%rbp)
	movq %rax, -96(%rbp) # t273 = (a_s4) + (b_s4)
	movq -96(%rbp), %rax # t90 = t273 {canonical: (a_s4) + (b_s4)}
	movq %rax, -104(%rbp)
	movq -104(%rbp), %rax
...
_block_140:
	...
	addq -56(%rbp), %rax
	movq %rax, -88(%rbp)
	movq %rax, -96(%rbp) # t274 = (a_s4) + (b_s4)
	movq -96(%rbp), %rax # t121 = t274 {canonical: (a_s4) + (b_s4)}
	movq %rax, -104(%rbp)
	movq -104(%rbp), %rax
...
_block_189:
	...
	addq -56(%rbp), %rax
	movq %rax, -88(%rbp)
	movq %rax, -96(%rbp) # t275 = (c_s4) + (b_s4)
	movq -96(%rbp), %rax # t167 = t275 {canonical: (c_s4) + (b_s4)}
	movq %rax, -104(%rbp)
	movq -104(%rbp), %rax
	...
	imulq -104(%rbp), %rax
	movq %rax, -80(%rbp)
	movq $1, -112(%rbp) # t185 = 1
	movq -112(%rbp), %rax # c_s4 += t185
	addq %rax, -64(%rbp)
	movq -64(%rbp), %rax
	jmp _nop_190
_nop_190:
...
_block_261:
	...
	addq -56(%rbp), %rax
	movq %rax, -88(%rbp)
	movq %rax, -96(%rbp) # t278 = (a_s4) + (b_s4)
	movq -96(%rbp), %rax # t242 = t278 {canonical: (a_s4) + (b_s4)}
	movq %rax, -104(%rbp)
	movq -104(%rbp), %rax
