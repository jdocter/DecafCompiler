...
_block_162:
	...
	push %r8 # saving caller save reg
	push %r11 # saving caller save reg
	movq %r15, %rsi
	leaq _string_0(%rip), %rdi
	call printf
	popq %r11 # saving caller save reg
	popq %r8 # saving caller save reg
	...
	imulq -224(%rbp), %rax
	movq %rax, -232(%rbp)
	movq %rax, -240(%rbp) # t164 = ((MINUS[3]) + ((a_s2) / ((5) * (6)))) * (7)
	movq %r8, -32(%rbp) # b_s2 -= t164 {canonical: ((MINUS[3]) + ((a_s2) / ((5) * (6)))) * (7)}
	movq -240(%rbp), %rax # b_s2 -= t164 {canonical: ((MINUS[3]) + ((a_s2) / ((5) * (6)))) * (7)}
	subq %rax, -32(%rbp)
	movq -32(%rbp), %rax
