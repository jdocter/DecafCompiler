...
_block_441:
_block_1524:
	movq -96(%rbp), %r14 # r_s65 = shared_t11361 {canonical: center_s65}
	jmp _nop_1525
_nop_1525:
...
_block_2088:
	...
	addq -176(%rbp), %r15 # dot_s72 += t11370 {canonical: (unsharpMask_s0[((r_s65) * (731)) + (c_s65)]) + ((m1_s70) * (unsharpKernel_s0[0]))}
	...
	addq -248(%rbp), %r15 # dot_s72 += t11371 {canonical: (unsharpMask_s0[((r_s65) * (731)) + (c_s65)]) + ((m2_s70) * (unsharpKernel_s0[1]))}
	...
	addq -320(%rbp), %r15 # dot_s72 += t11372 {canonical: (unsharpMask_s0[((r_s65) * (731)) + (c_s65)]) + ((m3_s70) * (unsharpKernel_s0[2]))}
	...
	addq -424(%rbp), %r15 # dot_s72 += t11373 {canonical: (unsharpMask_s0[((r_s65) * (731)) + (c_s65)]) + ((unsharpMask_s0[((731) * (r_s65)) + (c_s65)]) * (unsharpKernel_s0[3]))}
	...
	addq -544(%rbp), %r15 # dot_s72 += t11374 {canonical: (unsharpMask_s0[((r_s65) * (731)) + (c_s65)]) + ((unsharpMask_s0[(((731) * (r_s65)) + (c_s65)) + (731)]) * (unsharpKernel_s0[4]))}
	...
	addq -664(%rbp), %r15 # dot_s72 += t11375 {canonical: (unsharpMask_s0[((r_s65) * (731)) + (c_s65)]) + ((unsharpMask_s0[(((731) * (r_s65)) + (c_s65)) + (1462)]) * (unsharpKernel_s0[5]))}
	...
	addq -784(%rbp), %r15 # dot_s72 += t11376 {canonical: (unsharpMask_s0[((r_s65) * (731)) + (c_s65)]) + ((unsharpMask_s0[(((731) * (r_s65)) + (c_s65)) + (2193)]) * (unsharpKernel_s0[6]))}
...
_block_2458:
_block_3541:
	movq -96(%rbp), %r14 # r_s55 = shared_t11381 {canonical: center_s55}
	jmp _nop_3542
_nop_3542:
...
_block_4105:
	...
	addq -176(%rbp), %r15 # dot_s62 += t11390 {canonical: (unsharpMask_s0[((r_s55) * (731)) + (c_s55)]) + ((m1_s60) * (unsharpKernel_s0[0]))}
	...
	addq -248(%rbp), %r15 # dot_s62 += t11391 {canonical: (unsharpMask_s0[((r_s55) * (731)) + (c_s55)]) + ((m2_s60) * (unsharpKernel_s0[1]))}
	...
	addq -320(%rbp), %r15 # dot_s62 += t11392 {canonical: (unsharpMask_s0[((r_s55) * (731)) + (c_s55)]) + ((m3_s60) * (unsharpKernel_s0[2]))}
	...
	addq -424(%rbp), %r15 # dot_s62 += t11393 {canonical: (unsharpMask_s0[((r_s55) * (731)) + (c_s55)]) + ((unsharpMask_s0[((731) * (r_s55)) + (c_s55)]) * (unsharpKernel_s0[3]))}
	...
	addq -544(%rbp), %r15 # dot_s62 += t11394 {canonical: (unsharpMask_s0[((r_s55) * (731)) + (c_s55)]) + ((unsharpMask_s0[(((731) * (r_s55)) + (c_s55)) + (731)]) * (unsharpKernel_s0[4]))}
	...
	addq -664(%rbp), %r15 # dot_s62 += t11395 {canonical: (unsharpMask_s0[((r_s55) * (731)) + (c_s55)]) + ((unsharpMask_s0[(((731) * (r_s55)) + (c_s55)) + (1462)]) * (unsharpKernel_s0[5]))}
	...
	addq -784(%rbp), %r15 # dot_s62 += t11396 {canonical: (unsharpMask_s0[((r_s55) * (731)) + (c_s55)]) + ((unsharpMask_s0[(((731) * (r_s55)) + (c_s55)) + (2193)]) * (unsharpKernel_s0[6]))}
...
_block_4410:
	...
	jl _sp_method_exit_with_status_1
	leaq _global_image(%rip), %rdx
	movq (%rdx,%r14,8), %rdx # t4308 = image_s0[t4309]
	movq %rdx, -168(%rbp)
...
_block_6548:
_block_7598:
	movq -96(%rbp), %r14 # r_s45 = shared_t11403 {canonical: center_s45}
	jmp _nop_7599
_nop_7599:
...
_block_8700:
	...
	subq %r12, %rax
	movq %rax, -192(%rbp)
	movq %rax, %r14 # shared_t11421 = (w_s90) - (b_s90)
	movq -112(%rbp), %rdi
	cmpq $2300000, %rdi
	jge _sp_method_exit_with_status_1
	cmpq $0, %rdi
...
_block_10223:
	...
	addq -88(%rbp), %r13 # col_s10 += t10219
	jmp _nop_10224
_nop_10224:
