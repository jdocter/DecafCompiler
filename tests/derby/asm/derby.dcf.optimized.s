...
_block_1269:
	...
	jl _sp_method_exit_with_status_1
	leaq _global_image(%rip), %rdx
	movq (%rdx,%r13,8), %rdx # t990 = image_s0[t991]
	movq %rdx, -696(%rbp)
...
_block_420:
_block_1291:
	movq -88(%rbp), %rbx # c_s65 = shared_t11360 {canonical: (cols_s0) - (center_s65)}
	jmp _nop_1292
_nop_1292:
...
_block_1415:
	movq %r14, %r12
	movq %r14, %rbx # shared_t11361 = center_s65
	movq %rbx, %r15 # shared_t11361, t1399 = shared_t11361 {canonical: center_s65}
	movq %r15, %r13 # shared_t11361 = center_s65
	cmpq $9, %r15
	jge _sp_method_exit_with_status_1
	cmpq $0, %r15
	jl _sp_method_exit_with_status_1
	leaq _global_unsharpKernel(%rip), %rdx
	movq (%rdx,%r15,8), %rdx # t1398 = unsharpKernel_s0[t1399]
	movq %rdx, %rbx
	cmpq $9, %r12
	jge _sp_method_exit_with_status_1
	cmpq $0, %r12
...
_block_441:
_block_1524:
	movq %r13, %r12 # r_s65 = shared_t11361 {canonical: center_s65}
	jmp _nop_1525
_nop_1525:
...
_block_2088:
	...
	addq -176(%rbp), %rbx # dot_s72 += t11370 {canonical: (unsharpMask_s0[((r_s65) * (731)) + (c_s65)]) + ((m1_s70) * (unsharpKernel_s0[0]))}
	...
	addq -248(%rbp), %rbx # dot_s72 += t11371 {canonical: (unsharpMask_s0[((r_s65) * (731)) + (c_s65)]) + ((m2_s70) * (unsharpKernel_s0[1]))}
	...
	addq -320(%rbp), %rbx # dot_s72 += t11372 {canonical: (unsharpMask_s0[((r_s65) * (731)) + (c_s65)]) + ((m3_s70) * (unsharpKernel_s0[2]))}
	...
	addq -424(%rbp), %rbx # dot_s72 += t11373 {canonical: (unsharpMask_s0[((r_s65) * (731)) + (c_s65)]) + ((unsharpMask_s0[((731) * (r_s65)) + (c_s65)]) * (unsharpKernel_s0[3]))}
	...
	addq -544(%rbp), %rbx # dot_s72 += t11374 {canonical: (unsharpMask_s0[((r_s65) * (731)) + (c_s65)]) + ((unsharpMask_s0[(((731) * (r_s65)) + (c_s65)) + (731)]) * (unsharpKernel_s0[4]))}
	...
	addq -664(%rbp), %rbx # dot_s72 += t11375 {canonical: (unsharpMask_s0[((r_s65) * (731)) + (c_s65)]) + ((unsharpMask_s0[(((731) * (r_s65)) + (c_s65)) + (1462)]) * (unsharpKernel_s0[5]))}
	...
	addq -784(%rbp), %rbx # dot_s72 += t11376 {canonical: (unsharpMask_s0[((r_s65) * (731)) + (c_s65)]) + ((unsharpMask_s0[(((731) * (r_s65)) + (c_s65)) + (2193)]) * (unsharpKernel_s0[6]))}
...
_block_458:
_block_2110:
	movq -104(%rbp), %r12 # r_s65 = shared_t11362 {canonical: (rows_s0) - (center_s65)}
	jmp _nop_2111
_nop_2111:
...
_block_2188:
	...
	movq %r13, %rbx # t2175 = shared_t11361 {canonical: center_s65}
	cmpq $9, %rbx
	jge _sp_method_exit_with_status_1
	cmpq $0, %rbx
	jl _sp_method_exit_with_status_1
...
_block_2307:
	...
	jl _sp_method_exit_with_status_1
	leaq _global_unsharpKernel(%rip), %rdx
	movq (%rdx,%r13,8), %rdx # t2294 = unsharpKernel_s0[t2295]
	movq %rdx, %rbx
...
_block_2437:
_block_3308:
	movq -88(%rbp), %rbx # c_s55 = shared_t11380 {canonical: (cols_s0) - (center_s55)}
	jmp _nop_3309
_nop_3309:
...
_block_3432:
	...
	movq %r12, %r14 # shared_t11381, t3416 = shared_t11381 {canonical: center_s55}
	movq %r14, %rbx # shared_t11381 = center_s55
	cmpq $9, %r14
	jge _sp_method_exit_with_status_1
	cmpq $0, %r14
	jl _sp_method_exit_with_status_1
	leaq _global_unsharpKernel(%rip), %rdx
	movq (%rdx,%r14,8), %rdx # t3415 = unsharpKernel_s0[t3416]
	movq %rdx, %r12
	cmpq $9, %r13
	jge _sp_method_exit_with_status_1
	cmpq $0, %r13
...
_block_2458:
_block_3541:
	movq %rbx, %r13 # r_s55 = shared_t11381 {canonical: center_s55}
	jmp _nop_3542
_nop_3542:
...
_block_2475:
_block_4127:
	movq -104(%rbp), %r13 # r_s55 = shared_t11382 {canonical: (rows_s0) - (center_s55)}
	jmp _nop_4128
_nop_4128:
...
_block_2481:
_block_4205:
	movq %rbx, %r13 # t4187 = shared_t11381 {canonical: center_s55}
	movq %rbx, %r12 # t4192 = shared_t11381 {canonical: center_s55}
	cmpq $9, %r12
	jge _sp_method_exit_with_status_1
	cmpq $0, %r12
	jl _sp_method_exit_with_status_1
...
_block_4410:
	...
	jl _sp_method_exit_with_status_1
	leaq _global_image(%rip), %rdx
	movq (%rdx,%rbx,8), %rdx # t4308 = image_s0[t4309]
	movq %rdx, -168(%rbp)
...
_block_5630:
	...
	addq -112(%rbp), %r13 # col_s29 += t5626
	jmp _nop_5631
_nop_5631:
...
_block_6496:
	...
	addq -112(%rbp), %r15 # row_s29 += t6492
	jmp _nop_6497
_nop_6497:
...
_block_6527:
_block_7376:
	movq -88(%rbp), %rbx # c_s45 = shared_t11402 {canonical: (cols_s0) - (center_s45)}
	jmp _nop_7377
_nop_7377:
...
_block_7489:
	movq %r14, %rbx
	movq %r14, %r13 # shared_t11403 = center_s45
	movq %r13, %r12 # shared_t11403, t7473 = shared_t11403 {canonical: center_s45}
...
_block_8162:
	...
	addq -176(%rbp), %r13 # dot_s52 += t11412 {canonical: (unsharpMask_s0[((r_s45) * (731)) + (c_s45)]) + ((m1_s50) * (unsharpKernel_s0[0]))}
	...
	addq -248(%rbp), %r13 # dot_s52 += t11413 {canonical: (unsharpMask_s0[((r_s45) * (731)) + (c_s45)]) + ((m2_s50) * (unsharpKernel_s0[1]))}
	...
	addq -320(%rbp), %r13 # dot_s52 += t11414 {canonical: (unsharpMask_s0[((r_s45) * (731)) + (c_s45)]) + ((m3_s50) * (unsharpKernel_s0[2]))}
	...
	addq -424(%rbp), %r13 # dot_s52 += t11415 {canonical: (unsharpMask_s0[((r_s45) * (731)) + (c_s45)]) + ((unsharpMask_s0[((731) * (r_s45)) + (c_s45)]) * (unsharpKernel_s0[3]))}
	...
	addq -544(%rbp), %r13 # dot_s52 += t11416 {canonical: (unsharpMask_s0[((r_s45) * (731)) + (c_s45)]) + ((unsharpMask_s0[(((731) * (r_s45)) + (c_s45)) + (731)]) * (unsharpKernel_s0[4]))}
	...
	addq -664(%rbp), %r13 # dot_s52 += t11417 {canonical: (unsharpMask_s0[((r_s45) * (731)) + (c_s45)]) + ((unsharpMask_s0[(((731) * (r_s45)) + (c_s45)) + (1462)]) * (unsharpKernel_s0[5]))}
	...
	addq -784(%rbp), %r13 # dot_s52 += t11418 {canonical: (unsharpMask_s0[((r_s45) * (731)) + (c_s45)]) + ((unsharpMask_s0[(((731) * (r_s45)) + (c_s45)) + (2193)]) * (unsharpKernel_s0[6]))}
...
_block_6571:
_block_8262:
	movq -96(%rbp), %r12 # t8244 = shared_t11403 {canonical: center_s45}
	movq -96(%rbp), %r13 # t8249 = shared_t11403 {canonical: center_s45}
	cmpq $9, %r13
	jge _sp_method_exit_with_status_1
	cmpq $0, %r13
	jl _sp_method_exit_with_status_1
	leaq _global_unsharpKernel(%rip), %rdx
	movq (%rdx,%r13,8), %rdx # t8248 = unsharpKernel_s0[t8249]
	movq %rdx, %rbx
	cmpq $9, %r12
	jge _sp_method_exit_with_status_1
	cmpq $0, %r12
...
_block_8700:
	...
	subq %rbx, %rax
	movq %rax, -192(%rbp)
	movq %rax, %r15 # shared_t11421 = (w_s90) - (b_s90)
	movq -112(%rbp), %rdi
	cmpq $2300000, %rdi
	jge _sp_method_exit_with_status_1
	cmpq $0, %rdi
...
_block_8914:
	...
	imulq -208(%rbp), %rax
	movq %rax, -216(%rbp)
	movq %r15, -224(%rbp) # t8898 = shared_t11421 {canonical: (w_s90) - (b_s90)}
	movq -224(%rbp), %rax
	movq -128(%rbp), %rdi
	cmpq $2300000, %rdi
	jge _sp_method_exit_with_status_1
...
_block_9150:
	...
	imulq -208(%rbp), %rax
	movq %rax, -216(%rbp)
	movq %r15, -224(%rbp) # t9134 = shared_t11421 {canonical: (w_s90) - (b_s90)}
	movq -224(%rbp), %rax
	movq -128(%rbp), %rdi
	cmpq $2300000, %rdi
	jge _sp_method_exit_with_status_1
...
_block_10223:
	...
	addq -88(%rbp), %r12 # col_s10 += t10219
	jmp _nop_10224
_nop_10224:
